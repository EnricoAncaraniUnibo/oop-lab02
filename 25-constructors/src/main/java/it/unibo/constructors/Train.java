...
class Train {
    ...
    public Train(int numero1, int numero2, int numero3) {
        this.seats=numero1;
        this.firstClassSeats=numero2;
        this.secondClassSeats=numero3;
    }

    public Train(int numero1,int numero2) {
        this.firstClassSeats=numero1;
        this.secondClassSeats=numero2;
